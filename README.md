...
Web search via [Kagi Search API](https://help.kagi.com/kagi/api/search.html) for [OpenClaw](https://github.com/openclaw/openclaw).
...
- [Kagi Search API](https://help.kagi.com/kagi/api/search.html) access (request at support@kagi.com)
